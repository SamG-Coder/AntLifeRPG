...
`nReload restored the earlier autosave with two completed bonds and one in-progress encounter; the five-bond live snapshot had not yet reached the periodic save. Serialization tests separately verify the complete symmetric records.
